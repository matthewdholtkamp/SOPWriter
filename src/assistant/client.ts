...
- When converting from a structured legacy outline, preserve every legacy responsibility and procedure unless it is exact duplicate text. Do not compress operational content into summaries. Map all legacy responsibilities into Enclosure 2 and every numbered procedure section after legacy Responsibilities into Enclosure 3.
- For legacy fall-prevention conversions, preserve the operational coverage for Information Desk, Head Nurses/NCOICs, All Hospital Staff, adult and pediatric fall protocols, post-fall management, documentation, outpatient adult fall procedures, and outpatient pediatric fall procedures when present in the source.
